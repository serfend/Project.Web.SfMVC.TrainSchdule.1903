	...
	public static partial class ActionStatusMessage
	{
		public static class ApplyMessage
		{
			...
			public static class Request
			{
				...
				public static readonly ApiResult HaveNoVacationSinceExcept = new ApiResult(44120, "因异常而无休假。");
				public static readonly ApiResult CrossDayNotPermit = new ApiResult(44130, "跨日请假时间过长");
			}
