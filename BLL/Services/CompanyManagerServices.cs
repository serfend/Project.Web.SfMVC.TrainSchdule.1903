...
namespace BLL.Services
{
	public class CompanyManagerServices : ICompanyManagerServices
	{
		...
		{
			var list = _context.AppUsers.Where(u => u.CompanyInfo.Company.Code == code).OrderBy(u => u.Application.InvitedBy).ThenBy(u => u.CompanyInfo.Duties.Code).ThenByDescending(u => u.CompanyInfo.Title.Code);
