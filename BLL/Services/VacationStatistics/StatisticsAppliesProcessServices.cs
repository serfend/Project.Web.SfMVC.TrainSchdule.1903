...
namespace BLL.Services.VacationStatistics
{
	...
	public class StatisticsAppliesProcessServices : IStatisticsAppliesProcessServices
	{
		...
		private Tuple<IEnumerable<T>, bool> GetTargetStatistics<T>(string companyCode, DateTime target, IQueryable<T> db, IQueryable<Apply> applies, IQueryable<RecallOrder> recallDb) where T : StatisticsAppliesProcess, new()
		{
