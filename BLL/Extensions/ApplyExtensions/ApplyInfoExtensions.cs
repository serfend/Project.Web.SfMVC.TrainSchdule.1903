...
namespace BLL.Extensions.ApplyExtensions
{
    public static class ApplyInfoExtensions
    {
        ...
        public static ApplySummaryDto<Q> ToSummaryDto<T, Q>(this T model, Q request, IRedisCacheClient cache) where T : IAppliable, IHasGuidId where Q : IApplyRequestBase
        {
