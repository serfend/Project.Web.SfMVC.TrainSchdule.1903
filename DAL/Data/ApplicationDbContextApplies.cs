...
namespace DAL.Data
{
	public partial class ApplicationDbContext
	{
		...
		public DbSet<ApplyExecuteStatus> ApplyExcuteStatus { get; set; }public DbSet<Apply<ApplyRequest>> Applies { get; set; }
		public IQueryable<Apply<ApplyRequest>> AppliesDb => Applies.Where(a => !a.IsRemoved).Where(a => ((int)a.MainStatus & (int)MainStatus.Invalid) == 0);
