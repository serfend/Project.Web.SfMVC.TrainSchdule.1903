...
namespace DAL.Migrations
{
    ...
    [Migration("20210630130000_StatisticsAppliesRankCompanyName")]
    partial class StatisticsAppliesRankCompanyName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.ApplyInfo.ApplyComment", b =>
                {
                    ...
                    b.Property<string>("AnonymousNick")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Entities.Common.CommonNavigate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAL.Entities.Common.DataDictionary.CommonDataDictionary", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Color = "#333333",
                            Description = "发言或讲话",
                            GroupName = "PartyConferRecordType",
                            IsRemoved = false,
                            IsRemovedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Key = "1",
                            Value = 0
            ...
            modelBuilder.Entity("DAL.Entities.UserInfo.UserCompanyInfo", b =>
                {
                    ...
                    b.Property<string>("CompanyOfManageCode")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CompanyOfManageCode");
            ...
            modelBuilder.Entity("DAL.Entities.ZZXT.PartyUserRecord", b =>
                {
                    ...
                    b.ToTable("PartyUserRecords");
                });

            modelBuilder.Entity("DAL.Entities.ZZXT.PartyUserRecordContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PartyUserRecordContents");
                });

            modelBuilder.Entity("DAL.Entities.ZZXT.UserPartyInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAL.Entities.UserInfo.UserCompanyInfo", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Company", "CompanyOfManage")
                        .WithMany()
                        .HasForeignKey("CompanyOfManageCode");
            ...
            modelBuilder.Entity("DAL.Entities.ZZXT.PartyUserRecord", b =>
                {
                    b.HasOne("DAL.Entities.ZZXT.Conference.PartyBaseConference", "Conference")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.ZZXT.PartyUserRecordContent", b =>
                {
                    b.HasOne("DAL.Entities.ZZXT.PartyUserRecord", "Record")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.ZZXT.UserPartyInfo", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.ZZXT.PartyDuty", "Duty")
                        .WithMany()
                        .HasForeignKey("DutyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Entities.ZZXT.PartyGroup", "PartyGroup")
                        .WithMany()
