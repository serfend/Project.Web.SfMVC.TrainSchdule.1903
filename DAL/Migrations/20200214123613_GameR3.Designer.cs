...
namespace DAL.Migrations
{
    ...
    [Migration("20200214123613_GameR3")]
    partial class GameR3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.ApplyInfo.Apply", b =>
                {
                    ...
                    b.Property<string>("NowAuditCompany");

                    b.Property<string>("NowAuditCompanyName");
            ...
            modelBuilder.Entity("DAL.Entities.Game_r3.GiftCode", b =>
                {
                    b.HasOne("DAL.Entities.Game_r3.User", "ShareBy")
                        .WithMany()
                        .HasForeignKey("ShareById");
                });
