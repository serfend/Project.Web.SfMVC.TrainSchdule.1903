...
namespace DAL.Migrations
{
    ...
    [Migration("20200522121239_auditStream_companyCode")]
    partial class auditStream_companyCode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Vacations.VacationStatistics", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("DAL.Entities.Vacations.VacationStatisticsData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DAL.Entities.Vacations.VacationStatisticsDescription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DAL.Entities.Vacations.VacationStatisticsDescriptionDataStatusCount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DAL.Entities.Vacations.VacationStatistics", b =>
                {
                    b.HasOne("DAL.Entities.Vacations.VacationStatisticsDescription", "RootCompanyStatistics")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.Vacations.VacationStatisticsData", b =>
                {
                    b.HasOne("DAL.Entities.Vacations.VacationStatisticsDescriptionDataStatusCount", "ApplyCount")
                        .WithMany()
                        .HasForeignKey("ApplyCountId");

                    b.HasOne("DAL.Entities.Vacations.VacationStatisticsDescriptionDataStatusCount", "ApplyMembersCount")
                        .WithMany()
                        .HasForeignKey("ApplyMembersCountId");

                    b.HasOne("DAL.Entities.Vacations.VacationStatisticsDescriptionDataStatusCount", "ApplySumDayCount")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.Vacations.VacationStatisticsDescription", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Vacations.VacationStatisticsData", "CurrentLevelStatistics")
                        .WithMany()
                        .HasForeignKey("CurrentLevelStatisticsId");

                    b.HasOne("DAL.Entities.Vacations.VacationStatisticsData", "IncludeChildLevelStatistics")
                        .WithMany()
