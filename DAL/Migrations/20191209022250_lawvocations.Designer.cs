...
namespace DAL.Migrations
{
    ...
    [Migration("20191209022250_lawvocations")]
    partial class lawvocations
    {
            ...
            modelBuilder.Entity("DAL.Entities.Vocations.VocationAdditional", b =>
                {
                    ...
                    b.Property<Guid?>("ApplyRequestId1");
            ...
            modelBuilder.Entity("DAL.Entities.Vocations.VocationAdditional", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.ApplyInfo.ApplyRequest")
                        .WithMany("LawVocations")
                        .HasForeignKey("ApplyRequestId1");
                });
