...
namespace TrainSchdule.Controllers
{
    ...
    public partial class UsersController : Controller
    {
        ...
        public IActionResult DiyInfo(string id, [FromBody] UserDiyInfoModifyModel model)
        {
            ...
            if (id != targetUser.Id && !userActionServices.Permission(authByUser, ApplicationPermissions.User.CustomeInfo.Item, PermissionType.Write, new List<string> { targetUser.CompanyInfo.CompanyCode }, "修改用户自定义信息", out var failCompany)) return new JsonResult(ActionStatusMessage.Account.Auth.Invalid.Default);
