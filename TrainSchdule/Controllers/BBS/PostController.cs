...
namespace TrainSchdule.Controllers.BBS
{
    ...
    public class PostController : Controller
    {
        ...
        public IActionResult Post(Guid id)
        {
            ...
            var user = currentUserService.CurrentUser;
            var permit = userActionServices.Permission(targetUser, ApplicationPermissions.Activity.Post.Item, PermissionType.Write, new List<string> { targetUser.CompanyInfo.CompanyCode }, "删除动态", out var failCompany);
