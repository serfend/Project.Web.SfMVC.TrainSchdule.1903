...
namespace TrainSchdule.ViewModels.Statistics
{
	...
	public class CurrentLevelStatisticsDataModel
	{
		...
		/// 单位本级数据
		/// </summary>
		public virtual VacationStatisticsDescriptionData CurrentLevelStatistics { get; set; }

		/// <summary>
		/// 包含子单位数据
		/// </summary>
		public virtual VacationStatisticsDescriptionData IncludeChildLevelStatistics { get; set; }
	}
